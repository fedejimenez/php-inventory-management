<div class="modal fade" id="list_products_sales_Modal">
  <div class="modal-dialog sizeModal">
    <div class="bg-warning">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-user-circle" aria-hidden="true"></i> Select a Product
        </h4>
      </div>
      <div class="modal-body">
        <div class="container box">
          ...
          <div class="table-responsive">
            <div class="box-body">
              <table id="list_products_sales_data" class="table table-bordered table-striped">
                <thead>
                  <tr>
